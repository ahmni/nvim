...
local function get_jdtls_paths()
  ...
  path.runtimes = {
    ...
    {
      name = "JavaSE-21",
      path = vim.fn.expand("~/.sdkman/candidates/java/21.0.3-zulu"),
      --path = "/Users/apangjohnson/.sdkman/candidates/java/current/bin/java",
    },
    -- {
    --   name = 'JavaSE-18',
...
local function jdtls_setup(event)
  ...
  local cmd = {
    -- 💀
    "/Users/apangjohnson/.sdkman/candidates/java/current/bin/java",
